...
CREATE TABLE "user_workspace_visits" (
    ...
    CONSTRAINT "user_workspace_visits_pkey" PRIMARY KEY ("user_id","workspace_id")
);
...
-- AddForeignKey
ALTER TABLE "user_workspace_visits" ADD CONSTRAINT "user_workspace_visits_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_workspace_visits" ADD CONSTRAINT "user_workspace_visits_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
